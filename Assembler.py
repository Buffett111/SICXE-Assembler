...
class Section:
    ...
    def __debug_print__(self) -> str:
        ...
        print("Extdef:")
        for exd_s in self.__extdef_table:
            print("\t", exd_s, self.__extdef_table[d_s])
        print("}\n")
        # print each extref
        print("Extref:")
        for exr_s in self.__extref_table:
            print("\t", exr_s, self.__extref_table[r_s])
        print("}\n")
    ...
    def generate_literal_table(self) -> None:
        ...
        def insert_literals(index):
            #print("inserting literals table:", literal_table)
